    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                <a href="{{ route('books') }}"
                   class="font-bold mt-10 w-full px-4 py-3 text-center capitalize transition-colors duration-300 transform bg-[#FFC933] rounded hover:bg-[#FFC933DD] focus:outline-none focus:ring focus:ring-teal-300 focus:ring-opacity-80">
                    Books
                </a>
